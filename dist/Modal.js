...
var defaultSettings = __webpack_require__(9);
var dom = __webpack_require__(4);
var EventManager = __webpack_require__(10);
...
var Modal = function () {
    function Modal(trigger, options) {
        ...
        this.PS = _perfectScrollbar2['default'];
        ...
        if (options) _extends(this._options, options);

        this._trigger.addEventListener('click', function (ev) {
    ...
    Modal.prototype.generate = function generate(params, callback) {
        ...
        var header = this._options.header.use ? '<div class="modal-header"><span class="modal-header__title">' + params.title + '</span><button class="modal-header__closeBtn close"><svg width=\'1em\' height=\'1em\' fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.85" viewBox="0 0 24 24"><path d="M18 6L6 18M6 6l12 12"/></svg></button></div>' : '';

        var footer = this._options.footer.use ? '<div class="modal-footer"><button class="modal-footer__close close">\uB2EB\uAE30</button><button class="modal-footer__apply" style="background-color:' + this._options.footer.focusingColor + '">\uC801\uC6A9</button></div>' : '';
    ...
    Modal.prototype.open = function open(id) {
        ...
        var inputHeight = function inputHeight() {
            var contentHeight = scrollArea.scrollHeight;
            var maxHeight = window.innerHeight - 30;
            var substractHeight = function () {
                if (!_this2._options.footer.use && !_this2._options.header.use) return 30;else if (_this2._options.header.use && !_this2._options.footer.use || !_this2._options.footer.use && _this2._options.footer.use) return 80;else return 130;
            }();
            var scrollAreaHeight = contentHeight >= maxHeight ? maxHeight - substractHeight : contentHeight;
            scrollArea.style.height = scrollAreaHeight + 'px';
            return contentHeight >= maxHeight;
        };

        var checkHeight = inputHeight();
...
var initialize = __webpack_require__(12);
...
// Handlers
var handlers = {
  'click-rail': __webpack_require__(13),
  'drag-scrollbar': __webpack_require__(14),
  'keyboard': __webpack_require__(15),
  'wheel': __webpack_require__(16),
  'touch': __webpack_require__(17),
  'selection': __webpack_require__(18)
};
var nativeScrollHandler = __webpack_require__(19);
