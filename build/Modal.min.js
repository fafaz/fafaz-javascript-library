...
value:function(a){var b=window.innerHeight,d=Math.round(a.offsetHeight);!this._config.fullScreen&&b<=(0===d%2?d:d+1)?(a.style.marginTop="3%",a.style.marginBottom="3%",a.parentNode.style.overflowY="scroll"):a.parentNode.style.overflowY="hidden"}}]);return b}(f["default"]);e["default"]=h;k.exports=e["default"]},function(k,e,h){(function(e,c){k.exports=c()})(this,function(){return function(e){function c(m){if(g[m])return g[m].exports;var f=g[m]={i:m,l:!1,exports:{}};e[m].call(f.exports,f,f.exports,c);
f.l=!0;return f.exports}var g={};c.m=e;c.c=g;c.d=function(e,f,a){c.o(e,f)||Object.defineProperty(e,f,{configurable:!1,enumerable:!0,get:a})};c.n=function(e){var f=e&&e.__esModule?function(){return e["default"]}:function(){return e};c.d(f,"a",f);return f};c.o=function(c,f){return Object.prototype.hasOwnProperty.call(c,f)};c.p="";return c(c.s=0)}([function(e,c,h){c=(c=h(1))&&c.__esModule?c:{"default":c};c["default"].VERSION="2.1.0";e.exports=c["default"]},function(e,c,h){c.__esModule=!0;var g="function"===
typeof Symbol&&"symbol"===typeof Symbol.iterator?function(f){return typeof f}:function(f){return f&&"function"===typeof Symbol&&f.constructor===Symbol&&f!==Symbol.prototype?"symbol":typeof f};h=function(){function f(){if(!(this instanceof f))throw new TypeError("Cannot call a class as a function");this._eventHandler={};this.options={}}f.prototype.trigger=function(a){var d=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{},b=this._eventHandler[a]||[];if(!(0<b.length))return!0;b=b.concat();d.eventType=
a;var f=!1,e=[d],c=0;d.stop=function(){f=!0};d.currentTarget=this;d=arguments.length;c=Array(2<d?d-2:0);for(var g=2;g<d;g++)c[g-2]=arguments[g];1<=c.length&&(e=e.concat(c));for(c=0;b[c];c++)b[c].apply(this,e);return!f};f.prototype.once=function(a,d){if("object"===("undefined"===typeof a?"undefined":g(a))&&"undefined"===typeof d){var b=void 0;for(b in a)this.once(b,a[b])}else if("string"===typeof a&&"function"===typeof d){var f=this;this.on(a,function p(){for(var b=arguments.length,c=Array(b),e=0;e<
...
{},this;if("undefined"===typeof d){if("string"===typeof a)this._eventHandler[a]=void 0;else for(d in d=void 0,a)this.off(d,a[d]);return this}if(a=this._eventHandler[a]){var b,f;for(b=0;void 0!==(f=a[b]);b++)if(f===d){a.splice(b,1);break}}return this};return f}();c["default"]=h;e.exports=c["default"]}])})},function(k,e,h){Object.defineProperty(e,"__esModule",{value:!0});e.addEventDelegation=void 0;var g="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&
"function"===typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a};e.nodeToArray=function(a){var d=[];if(a)for(var b=0,f=a.length;b<f;b++)d.push(a[b]);return d};e.addEvent=function(a,d,b,c){if(m){var e=c||!1;"object"===("undefined"===typeof c?"undefined":g(c))&&(e=f?c:!1);a.addEventListener(d,b,e)}else a.attachEvent?a.attachEvent("on"+d,b):a["on"+d]=b};e.removeEvent=function(a,d,b){a.removeEventListener?a.removeEventListener(d,b,!1):a.detachEvent?a.detachEvent("on"+d,b):a["on"+
d]=null};e.hasClass=function(a,d){return a.classList?a.classList.contains(d):(new RegExp("(^| )"+d+"( |$)","gi")).test(a.className)};var c=(k=h(3))&&k.__esModule?k:{"default":k},n=("undefined"!==typeof window&&Math===Math?window:"undefined"!==typeof self&&(self.Math===Math?self:Function("return this")())).document,m=!!("addEventListener"in n),f=function(){var a=!1;try{m&&Object.defineProperty&&n.addEventListener("test",null,Object.defineProperty({},"passive",{get:function(){a=!0}}))}catch(d){}return a}();
e.addEventDelegation=function(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:"",d=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"click",b=arguments[2];return(0,c["default"])(a,d,function(a){b(a)},!1)}},function(k,e,h){function g(e,f,a,d,b){var g=c.apply(this,arguments);e.addEventListener(a,g,b);return{destroy:function(){e.removeEventListener(a,g,b)}}}function c(c,f,a,d){return function(a){a.delegateTarget=n(a.target,f);a.delegateTarget&&d.call(c,a)}}var n=h(4);k.exports=function(c,
f,a,d,b){if("function"===typeof c.addEventListener)return g.apply(null,arguments);if("function"===typeof a)return g.bind(null,document).apply(null,arguments);"string"===typeof c&&(c=document.querySelectorAll(c));return Array.prototype.map.call(c,function(c){return g(c,f,a,d,b)})}},function(k,e){"undefined"===typeof Element||Element.prototype.matches||(e=Element.prototype,e.matches=e.matchesSelector||e.mozMatchesSelector||e.msMatchesSelector||e.oMatchesSelector||e.webkitMatchesSelector);k.exports=
function(e,g){for(;e&&9!==e.nodeType;){if("function"===typeof e.matches&&e.matches(g))return e;e=e.parentNode}}},function(k,e){}])});
