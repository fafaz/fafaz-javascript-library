...
h._version="1.1";var c={theme:{useBorder:!0,borderColor:void 0,overlayColor:void 0},cloneNode:!0,fixedHeight:!1,useHeader:!0,usePreloader:!1};h._config=m({},c,b,{theme:m({},c.theme,b.theme)});h._triggers=(0,e.nodeToArray)(document.querySelectorAll(a));h._triggers.map(function(a,b){(0,e.addEvent)(a,"click",function(){var e={id:a.getAttribute("data-modal-id"),title:a.getAttribute("data-modal-title"),width:a.getAttribute("data-modal-width")?a.getAttribute("data-modal-width"):500,height:a.getAttribute("data-modal-height")?
a.getAttribute("data-modal-height"):null},b=h._config.cloneNode?"wrapper_"+e.id+"_temp":"wrapper_"+e.id;document.getElementById(b)?h.open(b):h.generate(e,function(){return h.open(b)})})});return h}b(d,a);l(d,[{key:"generate",value:function(a,b){var d=this,h=document.createElement("div"),c=document.getElementById(a.id);this._config.cloneNode?(c=c.cloneNode(!0),c.id=a.id+"_temp",h.id="wrapper_"+a.id+"_temp"):h.id="wrapper_"+a.id;h.classList.add("modal-overlay");h.classList.add("modal-close");c.classList.add("modal-content");
c.style.width=a.width+"px";this._config.fixedHeight&&a.height&&(c.style.height=a.height+"px");this._config.theme.overlayColor&&(h.style.backgroundColor=this._config.theme.overlayColor);this._config.theme.useBorder?this._config.theme.borderColor&&(c.style.borderColor=this._config.theme.borderColor):c.style.border="0";c.innerHTML=(this._config.useHeader?'<section class="modal-header"><h1 class="modal-header__title">'+a.title+'</h1><button class="modal-header__closeBtn modal-close"><svg width=\'1em\' height=\'1em\' fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1" viewBox="0 0 24 24"><path d="M18 6L6 18M6 6l12 12"/></svg></button></section>':
